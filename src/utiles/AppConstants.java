...
public class AppConstants {
    ...
    public static final String MENU5 = "5: service.User Registration";
    public static final String MENU6 = "6: View All Users";
    public static final String MENU7 = "7: Exit";

    // Error messages
    public static final String ERROR_USER_NOT_FOUND = "service.User not found!";
    public static final String ERROR_BOOK_NOT_FOUND = "service.Book not found!";
    ...
    public static final String USER_ALREADY_EXIST = "service.User ID already exists!";
    public static final String ENTER_VALID_GENRE = "Please select any one of the given genre!!!\n";

    // Success messages
    public static final String SUCCESS_BOOK_ADDED = "service.Book added successfully!";
    public static final String SUCCESS_BOOK_BORROWED = "service.Book borrowed successfully!";
    public static final String SUCCESS_BOOK_RETURNED = "service.Book returned successfully!";
    public static final String SUCCESS_USER_REGISTERED = "service.User registered successfully!";
    public static final String BYE_MESSAGE = "Exiting the Library Management System. Goodbye!";

    // Prompt messages
    public static final String PROMPT_ENTER_USER_ID = "Enter service.User ID (ex: ATS112): ";
